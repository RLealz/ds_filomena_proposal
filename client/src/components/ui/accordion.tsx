...
function AccordionContent({
  ...
  return (
    <AccordionPrimitive.Content
      ...
      className="data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:animate-in data-[state=open]:fade-in-0 overflow-hidden text-sm duration-200"
      {...props}
    >
